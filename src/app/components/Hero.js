      ...
      <div className={`${styles.flexCenter}`}>
        <div className={`relative my-12`}>
          <div className={`${styles.flexCenter} min-h-[627px] l:w-[1100px]`}>
            ...
            <div className={`z-10 absolute top-[-6%] right-[36px] m:right-0 m:left-[7%] m:-top-[13%] l:-left-[9%]`}>
              <RingOne />
            </div>
          ...
          <div className="-mt-[220px] l:mt-0 flex relative">
            <div className={`bg-card-hero absolute flex flex-col flex-nowrap h-[380px] w-[340px] gap-2.5 p-5 -top-[330px] left-1/2 translate-x-[-50%] l:left-[88%] l:-top-[670px] `}>
