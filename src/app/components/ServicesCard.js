...
export default function ServicesCard() {
  return (
    <section className="flex h-[800px] min-w-[375px] w-[800px] max-w-[100vw] rounded-l-[23px]">
                ...
                <div className={`flex justify-between w-full`}>
                  ...
                  <div className={`flex flex-col w-1/2 m-0 m:m-2.5 space-y-1`}>
                    <div className={`flex items-center mt-1`}>
                      <div className={`flex text-[10px] px-2 py-[3px] mr-1 rounded-full`}>1</div>
                      <h4 className={`${styles.headingMainCard} opacity-80`}>Cyber Seguridad</h4>
                    </div>
                    <div className={`flex items-center`}>
                      <div className={`flex text-[10px] px-2 py-[3px] mr-1 rounded-full`}>2</div>
                      <h4 className={`${styles.headingMainCard} opacity-80`}>Conectividad</h4>
                    </div>
                    <div className={`flex items-center`}>
                      <div className={`flex text-[10px] px-2 py-[3px] mr-1 rounded-full`}>3</div>
                      <h4 className={`${styles.headingMainCard} opacity-80`}>Instalacion</h4>
                    </div>
                    <div className={`flex items-center`}>
                      <div className={`flex text-[10px] px-2 py-[3px] mr-1 rounded-full`}>4</div>
                      <h4 className={`${styles.headingMainCard} opacity-80`}>Hardware</h4>
                    </div>
                    <div className={`flex items-center`}>
                      <div className={`flex text-[10px] px-2 py-[3px] mr-1 rounded-full`}>5</div>
