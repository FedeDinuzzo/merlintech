  ...
  return (
    <section id="home" className={`flex flex-col flex-wrap justify-center gap-5`}>
      ...
      <div className={`${styles.flexCenter} flex-wrap p-5 m:p-8 l:p-10 gap-5 m:gap-10 max-w-[1100px] mx-auto`}>
        ...
        <div className={`flex flex-col h-[380px] w-[340px] m:w-[620px] gap-2.5`}>
          <div className={`absolute h-[380px] w-[340px] m:w-[620px] bg-card-service z-0`}>
            <Image className={`absolute h-[380px] rounded-[40px]`} src={cardInnerShadow} alt="supportIT" />
          </div>
        ...
        <div className={`flex flex-col min-h-[380px] w-[340px] m:w-[620px] gap-2.5`}>
          <div className={`absolute h-[410px] m:h-[380px] w-[340px] m:w-[620px] bg-card-service z-0`}>
