...
export const Button = ({ text, link, image, tgt }) => {
  return (
    <Link href={`${link}`} aria-label={link} target={tgt}>
...
export const ButtonTwo = ({ text, link, image, tgt }) => {
  return (
    <Link href={`${link}`} aria-label={link} target={tgt}>
...
export const ButtonThree = ({ text, link, image, tgt }) => {
  return (
    <Link href={`${link}`} aria-label={link} target={tgt}>
...
export const ButtonFour = ({ text, link, image, tgt }) => {
  return (
    <Link className="max-w-[260px]" href={`${link}`} smooth="true" aria-label={link} target={tgt}>
