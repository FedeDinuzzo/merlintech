const styles = {
  ...
  heading3Contact: "font-inter font-medium text-[30px] text-white leading-10 w-full",
  headingMainCard: "font-inter text-[10.5px] text-white w-full",
  headingServicesCard: "font-inter text-[13px] text-white w-full",
